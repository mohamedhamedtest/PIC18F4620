...
# 2 "<built-in>" 2
# 1 "mcal_layer/ecu_lcd.c" 2
# 1 "mcal_layer/ecu_lcd.h" 1
# 10 "mcal_layer/ecu_lcd.h"
# 1 "mcal_layer/../mcal_layer/GPIO/hal_gpio.h" 1
# 11 "mcal_layer/../mcal_layer/GPIO/hal_gpio.h"
...
# 11 "mcal_layer/../mcal_layer/GPIO/hal_gpio.h" 2

# 1 "mcal_layer/../mcal_layer/GPIO/../mcal_std_types.h" 1
# 11 "mcal_layer/../mcal_layer/GPIO/../mcal_std_types.h"
...
# 11 "mcal_layer/../mcal_layer/GPIO/../mcal_std_types.h" 2
...
# 12 "mcal_layer/../mcal_layer/GPIO/../mcal_std_types.h" 2
...
# 12 "mcal_layer/../mcal_layer/GPIO/hal_gpio.h" 2

# 1 "mcal_layer/../mcal_layer/GPIO/../device_config.h" 1
# 13 "mcal_layer/../mcal_layer/GPIO/hal_gpio.h" 2

# 1 "mcal_layer/../mcal_layer/GPIO/hal_gpio_cfg.h" 1
# 14 "mcal_layer/../mcal_layer/GPIO/hal_gpio.h" 2
# 38 "mcal_layer/../mcal_layer/GPIO/hal_gpio.h"
typedef enum {
       LOW =0,
       HIGH
}logic_t;
...
# 10 "mcal_layer/ecu_lcd.h" 2

# 1 "mcal_layer/ecu_lcd_con.h" 1
# 11 "mcal_layer/ecu_lcd.h" 2
# 44 "mcal_layer/ecu_lcd.h"
typedef struct{
    pin_config_t lcd_rs;
    pin_config_t lcd_en;
...
static Std_returntype lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 coulmn){
    ...
    switch(row){
        ...
        case 3 : ret = lcd_8bit_send_command(lcd, (0x90 + coulmn)); break;
        case 4 : ret = lcd_8bit_send_command(lcd, (0xd0 + coulmn)); break;
        default : ;
    }
    return ret;
}
# 414 "mcal_layer/ecu_lcd.c"
static Std_returntype lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 coulmn){
    Std_returntype ret = ( Std_returntype)0x01;
    coulmn--;
    switch(row){
