...
# 1 "MCAL_Layer/SPI/../GPIO/../std_types.h" 1
# 12 "MCAL_Layer/SPI/../GPIO/../std_types.h"
# 1 "MCAL_Layer/SPI/../GPIO/../compiler.h" 1
# 13 "MCAL_Layer/SPI/../GPIO/../compiler.h"
...
# 13 "MCAL_Layer/SPI/../GPIO/../compiler.h" 2
# 12 "MCAL_Layer/SPI/../GPIO/../std_types.h" 2

# 1 "MCAL_Layer/SPI/../GPIO/../std_libraries.h" 1
# 13 "MCAL_Layer/SPI/../GPIO/../std_libraries.h"
...
# 15 "MCAL_Layer/SPI/../GPIO/../std_libraries.h" 2
# 13 "MCAL_Layer/SPI/../GPIO/../std_types.h" 2
...
# 16 "MCAL_Layer/SPI/../GPIO/hal_gpio.h" 2
# 37 "MCAL_Layer/SPI/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
static void spi_clock_phase(const spi_t *spi);
static void spi_clock_polarity(const spi_t *spi);
static void spi_pins_configuration_for_master(const spi_t *spi);
static void spi_pins_configuration_for_slave(const spi_t *spi);
static void spi_sample_data_for_master(const spi_t *spi);
static void spi_sample_data_for_slave(const spi_t *spi);
...
Std_ReturnType spi_master_initialize(const spi_t *spi) {
    ...
    if (((void*)0) == spi) {
        ...
        (SSPCON1bits.SSPEN=1);
        spi_clock_polarity(spi);
        spi_clock_phase(spi);
        spi_sample_data_for_master(spi);
        spi_pins_configuration_for_master(spi);
...
Std_ReturnType spi_slave_initialize(const spi_t *spi)
{
    ...
    if (((void*)0) == spi) {
        ret = (Std_ReturnType)0x00;
          ...
          spi_clock_polarity(spi);
          spi_clock_phase(spi);
          spi_sample_data_for_slave(spi);
        spi_pins_configuration_for_slave(spi);
...
static void spi_clock_phase(const spi_t *spi)
{
        switch (spi->clock_phase) {
                case SPI_TRANSMIT_OCCURE_FROM_ACTIVE_TO_IDLE_CLOCK:
                    (SSPSTATbits.CKE=1);
                    break;
                case SPI_TRANSMIT_OCCURE_FROM_IDLE_TO_ACTIVE_CLOCK:
                    (SSPSTATbits.CKE=0);
                    break;
            }
}
...
static void spi_clock_polarity(const spi_t *spi)
{
    switch (spi->clock_polarity) {
                case SPI_CLOCK_POLARITY_IDLE_STATE_IS_HIGH:
                    (SSPCON1bits.CKP=1);
                    break;
                case SPI_CLOCK_POLARITY_IDLE_STATE_IS_LOW:
                    (SSPCON1bits.CKP=0);
                    break;
            }
}
...
static void spi_pins_configuration_for_master(const spi_t *spi) {
    ...
    if (spi->master_or_slave == SPI_MASTER_SELECTED) {
        TRISCbits.RC3 = 0;

    } else {

    }
        ret = gpio_pin_intialize(&(spi->master_selcet_pin));
...
static void spi_pins_configuration_for_slave(const spi_t *spi)
{
    ...
    if (spi->master_or_slave == SPI_SLAVE_SELECTED) {
        TRISCbits.RC3=1;
...
static void spi_sample_data_for_master(const spi_t *spi)
{
    if(spi->master_or_slave == SPI_MASTER_SELECTED )
    {
         switch (spi->sample_data_state) {
                case SPI_NNPUT_SAMPLE_DATA_AT_END_OUTPUT_TIME:
                    (SSPSTATbits.SMP=1);
                    break;
                case SPI_NNPUT_SAMPLE_DATA_AT_MIDDLE_OUTPUT_TIME:
                    (SSPSTATbits.SMP=0);
                    break;
            }
    }
