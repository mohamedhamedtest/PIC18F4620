...
# 10 "MCAL_Layer/Timer1/hal_timer1.h"
...
# 12 "MCAL_Layer/Timer1/../GPIO/../std_types.h"
# 1 "MCAL_Layer/Timer1/../GPIO/../compiler.h" 1
# 13 "MCAL_Layer/Timer1/../GPIO/../compiler.h"
...
# 13 "MCAL_Layer/Timer1/../GPIO/../compiler.h" 2
# 12 "MCAL_Layer/Timer1/../GPIO/../std_types.h" 2

# 1 "MCAL_Layer/Timer1/../GPIO/../std_libraries.h" 1
# 13 "MCAL_Layer/Timer1/../GPIO/../std_libraries.h"
...
# 13 "MCAL_Layer/Timer1/../GPIO/../std_types.h" 2
...
# 37 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 10 "MCAL_Layer/Timer1/hal_timer1.h" 2

# 1 "MCAL_Layer/Timer1/../interrupt/mcal_internal_interrupt.h" 1
# 10 "MCAL_Layer/Timer1/../interrupt/mcal_internal_interrupt.h"
...
# 53 "MCAL_Layer/Timer1/../interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 10 "MCAL_Layer/Timer1/../interrupt/mcal_internal_interrupt.h" 2
...
static void timer1_write_value(const timer1_t *timer1);
static void timer1_read_write_operation_select(const timer1_t *timer1);
static void timer1_oscillator_state(const timer1_t *timer1);
static void timer1_t1cki_asych_sych_select(const timer1_t *timer1);
...
Std_ReturnType timer1_initialize(const timer1_t *timer1)
{
    ...
    if(((void*)0) == timer1){
        ...
        (T1CONbits.TMR1ON=0);
         switch (timer1->mode) {
        case TIMER1_COUNTER_MODE_RISING_EDGE:
            (T1CONbits.TMR1CS=1);
            break;
        case TIMER1_TIMER_MODE:
           ...
           switch(timer1->read_write_state)
    {
        case TIMER1_READ_WRITE_ONE_16BIT_OPERATION:
            (T1CONbits.RD16=1);
            break;
        case TIMER1_READ_WRITE_TWO_8BIT_OPERATION:
            (T1CONbits.RD16=0);
            break;
    }
        (T1CONbits.T1CKPS=timer1->prescaler);

            TMR1H=(uint8)((timer1->timer1_initial_value)>>8);
            TMR1L=(uint8)(timer1->timer1_initial_value);


        timer1_oscillator_state(timer1->osc_state);
        timer1_t1cki_asych_sych_select(timer1->t1cki_state);
        timer1_preload_value=timer1->timer1_initial_value;
# 78 "MCAL_Layer/Timer1/hal_timer1.c"
      (T1CONbits.TMR1ON=1);
...
Std_ReturnType timer1_Read_Value(const timer1_t *timer1, uint16 *timer1_value) {
    ...
    if (((void*)0) == timer1) {
        ...
        temp_tmrl =(uint16)TMR1L;
        temp_tmrh =(uint16)(TMR1H << 8);
        *timer1_value = temp_tmrl | temp_tmrh;
...
static void timer1_t1cki_asych_sych_select(const timer1_t *timer1)
{
         switch(timer1->t1cki_state)
    {
        case TIMER1_EXTERNAL_CLOCKS_T1CKI_SYNCHRONIZE:
             (T1CONbits.T1SYNC=1);
            break;
        case TIMER1_EXTERNAL_CLOCKS_T1CKI_ASYNCHRONIZE:
            (T1CONbits.T1SYNC=0);
            break;
    }
}
