...
# 10 "MCAL_Layer/I2C/hal_i2c.h"
# 1 "MCAL_Layer/I2C/../GPIO/hal_gpio.h" 1
# 14 "MCAL_Layer/I2C/../GPIO/hal_gpio.h"
...
# 1 "MCAL_Layer/I2C/../GPIO/../std_types.h" 1
# 12 "MCAL_Layer/I2C/../GPIO/../std_types.h"
# 1 "MCAL_Layer/I2C/../GPIO/../compiler.h" 1
# 13 "MCAL_Layer/I2C/../GPIO/../compiler.h"
...
# 13 "MCAL_Layer/I2C/../GPIO/../compiler.h" 2
# 12 "MCAL_Layer/I2C/../GPIO/../std_types.h" 2

# 1 "MCAL_Layer/I2C/../GPIO/../std_libraries.h" 1
# 13 "MCAL_Layer/I2C/../GPIO/../std_libraries.h"
...
# 15 "MCAL_Layer/I2C/../GPIO/../std_libraries.h" 2
# 13 "MCAL_Layer/I2C/../GPIO/../std_types.h" 2
...
# 16 "MCAL_Layer/I2C/../GPIO/hal_gpio.h" 2
# 37 "MCAL_Layer/I2C/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
static void i2c_pin_configuration(void);

static void i2c_clock_gen_for_master_configuration(const i2c_t *i2c);
static void i2c_set_slave_address_configuration(const i2c_t *i2c);
...
Std_ReturnType i2c_master_mode_intialize(const i2c_t *i2c) {
    ...
    if (((void*)0) == i2c) {
        ...
        (SSPCON1bits.SSPM=i2c->ic2_mode_selected);

        i2c_clock_gen_for_master_configuration(i2c);
        if(i2c->i2c_master_mode_transmit_or_receiver == (0x01))
        {
            (SSPCON2bits.RCEN=1);
        }
        else
...
Std_ReturnType i2c_slave_mode_intialize(const i2c_t *i2c) {
    ...
    if (((void*)0) == i2c) {
        ...
        i2c_pin_configuration();

        (SSPCON1bits.SSPEN=1);

        (SSPCON1bits.SSPM=i2c->ic2_mode_selected);

        i2c_set_slave_address_configuration(i2c);
...
Std_ReturnType i2c_send_address(uint8 Address_With_WR_Bit, uint8 *address_match_status) {
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 temp = 0;
    SSPBUF = Address_With_WR_Bit;
    while (!PIR1bits.SSPIF);
    if (PIR1bits.SSPIF == 1) {
        *address_match_status = (0X00);
    } else {
        *address_match_status = (0X01);
    }
    PIR1bits.SSPIF = 0;
...
static void i2c_clock_gen_for_master_configuration(const i2c_t *i2c)
{
       SSPADD = (uint8)(((4000000UL / 4.0) / (i2c->i2c_clock_frequancy_for_master)) - 1);
}

static void i2c_set_slave_address_configuration(const i2c_t *i2c)
{
    SSPADD=(uint8)(i2c->i2c_slave_address_for_slave);
}
