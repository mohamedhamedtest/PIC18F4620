...
# 10 "MCAL_Layer/Timer0/hal_timer0.h"
...
# 12 "MCAL_Layer/Timer0/../GPIO/../std_types.h"
...
# 12 "MCAL_Layer/Timer0/../GPIO/../std_types.h" 2
...
# 13 "MCAL_Layer/Timer0/../GPIO/../std_types.h" 2
...
# 37 "MCAL_Layer/Timer0/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 10 "MCAL_Layer/Timer0/hal_timer0.h" 2

# 1 "MCAL_Layer/Timer0/../interrupt/mcal_internal_interrupt.h" 1
# 10 "MCAL_Layer/Timer0/../interrupt/mcal_internal_interrupt.h"
...
# 53 "MCAL_Layer/Timer0/../interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 10 "MCAL_Layer/Timer0/../interrupt/mcal_internal_interrupt.h" 2
# 11 "MCAL_Layer/Timer0/hal_timer0.h" 2
...
# 7 "MCAL_Layer/Timer0/hal_timer0.c" 2


static void(*Timer0_InterruptHandler)(void) = ((void*)0);

volatile uint16 timer0_preload_value=0;


static void timer0_select_size(const timer0_t *timer0);
static void timer0_select_mode(const timer0_t *timer0);
static void timer0_select_transition(const timer0_t *timer0);
static void timer0_prescaler_state(const timer0_t *timer0);
static void timer0_write_value(const timer0_t *timer0);
...
Std_ReturnType timer0_initialize(const timer0_t *timer0)
{
    ...
    if(((void*)0) == timer0){
        ...
        timer0_preload_value=timer0->timer0_initial_value;
        TMR0L=0;
        TMR0H=0;
        (T0CONbits.TMR0ON=0);
        timer0_select_size(timer0);
        timer0_select_mode(timer0);
        timer0_select_transition(timer0);
        timer0_prescaler_state(timer0);
        (T0CONbits.T0PS=timer0->prescaler_select);
        timer0_write_value(timer0);
# 60 "MCAL_Layer/Timer0/hal_timer0.c"
        (T0CONbits.TMR0ON=1);
...
Std_ReturnType timer0_read_value(const timer0_t *timer0,uint16 *timer0_value)
{
          ...
          switch(timer0->size)
    {
        ...
        case TIMER0_16BIT_REGISTER:
            temp_tmr0l=(uint16)TMR0L;
            temp_tmr0h=(uint16)(TMR0H<<8);
            *timer0_value=temp_tmr0l | temp_tmr0h;
...
Std_ReturnType timer0_Write_Value(const timer0_t *timer0,uint16 *timer0_value)
{
          ...
          switch(timer0->size)
    {
        case TIMER0_8BIT_REGISTER:
            ...
            TMR0L=timer0->timer0_initial_value;
            break;
        case TIMER0_16BIT_REGISTER:
            TMR0H=(uint8)timer0->timer0_initial_value>>8;
            TMR0L=(uint8)timer0->timer0_initial_value;
...
static void timer0_select_size(const timer0_t *timer0)
{
    switch(timer0->size)
    {
        case TIMER0_8BIT_REGISTER: (T0CONbits.T08BIT=1);break;
        case TIMER0_16BIT_REGISTER: (T0CONbits.T08BIT=0);break;
    }
}
...
static void timer0_select_mode(const timer0_t *timer0)
{
     switch(timer0->mode)
    {
        case TIMER0_TIMER_MODE: (T0CONbits.T0CS=0);break;
        case TIMER0_COUNTER_MODE: (T0CONbits.T0CS=1);break;
    }
}
static void timer0_select_transition(const timer0_t *timer0)
{
      switch(timer0->transition_state)
    {
        case TIMER0_T0CKI_HIGH_TO_LOW: (T0CONbits.T0SE=1);break;
        case TIMER0_T0CKI_LOW_TO_HIGH: (T0CONbits.T0SE=0);break;
    }
}
static void timer0_prescaler_state(const timer0_t *timer0)
{
       switch(timer0->prescaler_state)
    {
        case TIMER0_PRESCALER_DISBALE: (T0CONbits.PSA=1);break;
        case TIMER0_PRESCALER_ENABLE: (T0CONbits.PSA=0);break;
    }
}
static void timer0_write_value(const timer0_t *timer0)
{
