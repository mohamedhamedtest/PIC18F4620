...
# 10 "MCAL_Layer/Timer3/hal_timer3.h"
...
# 12 "MCAL_Layer/Timer3/../GPIO/../std_types.h"
# 1 "MCAL_Layer/Timer3/../GPIO/../compiler.h" 1
# 13 "MCAL_Layer/Timer3/../GPIO/../compiler.h"
...
# 13 "MCAL_Layer/Timer3/../GPIO/../compiler.h" 2
# 12 "MCAL_Layer/Timer3/../GPIO/../std_types.h" 2

# 1 "MCAL_Layer/Timer3/../GPIO/../std_libraries.h" 1
# 13 "MCAL_Layer/Timer3/../GPIO/../std_libraries.h"
...
# 13 "MCAL_Layer/Timer3/../GPIO/../std_types.h" 2
...
# 37 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 10 "MCAL_Layer/Timer3/hal_timer3.h" 2

# 1 "MCAL_Layer/Timer3/../interrupt/mcal_internal_interrupt.h" 1
# 10 "MCAL_Layer/Timer3/../interrupt/mcal_internal_interrupt.h"
...
# 53 "MCAL_Layer/Timer3/../interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 10 "MCAL_Layer/Timer3/../interrupt/mcal_internal_interrupt.h" 2
# 11 "MCAL_Layer/Timer3/hal_timer3.h" 2
# 29 "MCAL_Layer/Timer3/hal_timer3.h"
typedef enum {
...
typedef enum{
    TIMER3_EXTERNAL_CLOCKS_ASYN,
     TIMER3_EXTERNAL_CLOCKS_SYN
}timer3_external_clocks_state_t;


typedef enum{
    TIMER3_READ_WRITE_ONE_16BIT,
    TIMER3_READ_WRITE_TWO_8BIT
}timer3_read_write_mode_t;
...
typedef struct{
  ...
  timer3_mode_t timer3_mode;
  timer3_prescaler_select_t timer3_prescaler;
  timer3_external_clocks_state_t timer3_external_clocks_state;
  timer3_read_write_mode_t timer3_read_write_mode;
  uint16 timer3_initial_value;
}timer3_t;
...
static void timer3_select_read_write_mode(const timer3_t *timer3);
static void timer3_external_clocks_sych_asych_select(const timer3_t *timer3);
static void timer3_write_value(const timer3_t *timer3);
...
Std_ReturnType Timer3_Init(const timer3_t *_timer3) {
    ...
    if (((void*)0) == _timer3) {
        ...
        (T3CONbits.TMR3ON=0);
        (T3CONbits.T3CKPS=_timer3->timer3_prescaler);
        timer3_select_mode(_timer3);
        timer3_select_read_write_mode(_timer3);
        timer3_external_clocks_sych_asych_select(_timer3);
        timer3_write_value(_timer3);
        Timer3_Preload_Value=_timer3->timer3_initial_value;
# 56 "MCAL_Layer/Timer3/hal_timer3.c"
        (T3CONbits.TMR3ON=1);
...
static void timer3_select_mode(const timer3_t *timer3)
{
    switch(timer3->timer3_mode)
    {
        case TIMER3_TIMER_MODE: (T3CONbits.TMR3CS=0); break;
        case TIMER3_COUNTER_MODE: (T3CONbits.TMR3CS=1); break;
    }
}
static void timer3_select_read_write_mode(const timer3_t *timer3)
{
     switch(timer3->timer3_read_write_mode)
    {
        case TIMER3_READ_WRITE_ONE_16BIT: (T3CONbits.RD16=1); break;
        case TIMER3_READ_WRITE_TWO_8BIT: (T3CONbits.RD16=0); break;
    }

}
static void timer3_external_clocks_sych_asych_select(const timer3_t *timer3)
{
     switch(timer3->timer3_external_clocks_state)
    {
        case TIMER3_EXTERNAL_CLOCKS_ASYN: (T3CONbits.T3SYNC=1); break;
        case TIMER3_EXTERNAL_CLOCKS_SYN: (T3CONbits.T3SYNC=0); break;
    }
}
static void timer3_write_value(const timer3_t *timer3)
{
            TMR3H=(uint8)((timer3->timer3_initial_value)>>8);
            TMR3L=(uint8)(timer3->timer3_initial_value);
}
